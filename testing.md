...
| 12 | Delete users' recipes if required. | Aside from the users to whom the recipes belong, the only person to be able to delete them is the admin. | [Buttons for editing and deleting a recipe](docs/testing/featuretesting/crudtesting/updatetesting/editdeletebuttons.png) |
